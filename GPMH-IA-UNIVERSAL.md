...
O código-fonte do GitHub não contém fontes comerciais nem o kit completo. O pacote completo e a skill com ativos podem ser baixados na [release pública](https://github.com/luisbezerragrowth/design-gpmh/releases/tag/v1.1.0-rc1), sem login ou convite. Quem clonar somente a fonte pode anexar o kit à sua cópia. A abertura de acesso foi solicitada por Luis em 24/09/2026; não constitui comprovação de licença. A existência dos arquivos não concede sublicença PP Neue Corp. Sem fonte licenciada acessível, não substituir silenciosamente por outra família nem declarar fidelidade final.
